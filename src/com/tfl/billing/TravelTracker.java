...
public class TravelTracker implements ScanListener {
    ...
    static final BigDecimal OFF_PEAK_JOURNEY_UPPER_PRICE = new BigDecimal(7.00);
    ...
    static final BigDecimal PEAK_JOURNEY_UPPER_PRICE = new BigDecimal(9.00);
    ...
    private void totalJourneysFor(Customer customer) {
        ...
        if(customerTotal.compareTo(PEAK_JOURNEY_UPPER_PRICE) >= 0 && tagPeak == 1){
            customerTotal = PEAK_JOURNEY_UPPER_PRICE;
        }
        else if(customerTotal.compareTo(OFF_PEAK_JOURNEY_UPPER_PRICE) >= 0 && tagPeak == 0){
            customerTotal = OFF_PEAK_JOURNEY_UPPER_PRICE;
        }
